...
class DashboardScreen extends StatelessWidget {
  ...
  DashboardScreen({
    ...
    required this.onNavigate, required Null Function(dynamic course) onCourseSelect,
  });
            ...
            child: Column(
              children: [
                ...
                Column(
                  ...
                  children: [
                    Text(
                      'Welcome back${userProfile.province != null ? ', learner from ${userProfile.province}' : ''}!',
                ...
                Row(
                  ...
                  children: [
                    _buildStatCard('Subjects', userProfile.subjects.length,
                        Icons.book, Colors.blue),
                    _buildStatCard('Interests', userProfile.interests.length,
                        Icons.star, Colors.green),
                    _buildStatCard(
                        'Matches', 12, Icons.trending_up, Colors.purple),
                  ],
                ),
                const SizedBox(height: 20),
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Wrap(
                                      ...
                                      runSpacing: 2,
                                      children: [
                                        ...course.requiredSubjects.take(2).map(
                                              (s) => Chip(
                                            label: Text(s,
                                                style: const TextStyle(
                                                    fontSize: 10)),
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: const [
          BottomNavigationBarItem(
              icon: Icon(Icons.school, color: Colors.blue), label: 'Courses'),
          BottomNavigationBarItem(
              icon: Icon(Icons.attach_money, color: Colors.grey),
              label: 'Funding'),
          BottomNavigationBarItem(
              icon: Icon(Icons.bar_chart, color: Colors.grey), label: 'Jobs'),
          BottomNavigationBarItem(
